  ...
  return (
        ...
        <section className="md:flex justify-between min-h-screen items-center p-3.5 py-8">
          ...
          >
            ...
            <p>
              ...
              <br />
              <br />
              I&rsquo;m a passionate Photo Editor with expertise in shadow
              creation, color correction, retouching, and neck joint techniques.
              I specialize in delivering high-quality, visually appealing images
              for e-commerce, fashion, and product photography. With a keen eye
              for detail and a commitment to perfection, I ensure that every
              image meets the highest standards. I thrive in fast-paced
              environments, handling batch editing and meeting tight deadlines
              while maintaining consistency and quality. Continuously learning
              and adapting to new tools and techniques, I strive to enhance
              workflow efficiency and create stunning visuals. Excited to
              collaborate on projects that bring images to life! Let me know if
              you&rsquo;d like any refinements!
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: 150 }}
   ...
   <div>
          ...
          <div className="flex flex-col gap-7 items-center">
            <div className="shadow-lg rounded-lg overflow-hidden w-full max-w-[400px] hover:scale-105 transition duration-300">
              ...
              <p className="text-lg mt-3 p-3">
                ...
                two-sided light source, shadows might not be captured properly.
                We create and adjust them using Photoshop.
              </p>
            </div>
          </div>
        </div>
        <h1 className="font-bold text-3xl p-7 text-center">Color Colection</h1>
        <div className="grid w-full pb-16 pt-10 h-auto items-center m-auto gap-7 sm:grid-cols-2 md:grid-cols-3 px-4">
          {/* Left Column */}
          <div className="flex flex-col gap-7 items-center">
            <div className="shadow-lg rounded-lg overflow-hidden w-full max-w-[400px] hover:scale-105 transition duration-300">
              ...
              <p className="text-lg mt-3 p-3">
                ...
                temperature, contrast, and brightness to achieve flawless
                results.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-7 items-center">
            <div className="shadow-lg rounded-lg overflow-hidden w-full max-w-[400px] hover:scale-105 transition duration-300 ">
              ...
              <p className="text-lg mt-3 p-3">
                ...
                imperfections, remove moles if needed, and tackle other
                issues—all while preserving a natural appearance.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-7 items-center">
            <div className="shadow-lg rounded-lg overflow-hidden w-full max-w-[400px] hover:scale-105 transition duration-300">
              ...
              <p className="text-lg mt-3 p-3">
                ...
                eCommerce store, but don’t have a model? We can create a 3D
                ghost mannequin effect for your garments, allowing you to
                display the style and fit of your items without any issues.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-7 items-center">
            <div className="shadow-lg rounded-lg overflow-hidden w-full max-w-[400px] hover:scale-105 transition duration-300">
              ...
              <p className="text-lg mt-3 p-3">
                ...
                can still feature your clothes professionally. We can create a
                3D ghost mannequin effect to present your garments in a polished
                and realistic way.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-7 items-center">
            <div className="shadow-lg rounded-lg overflow-hidden w-full max-w-[400px] hover:scale-105 transition duration-300">
              ...
              <p className="text-lg mt-3 p-3">
                ...
                offering virtual body shaping and fitness improvements. We
                smooth skin, contour the body, and address imperfections like
                scars or marks, ensuring a flawless, natural appearance from
                head to toe.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-7 items-center">
            <div className="shadow-lg rounded-lg overflow-hidden w-full max-w-[400px] hover:scale-105 transition duration-300">
              ...
              <p className="text-lg mt-3 p-3">
                ...
                heavy makeup or lighting are corrected, ensuring flawless
                results. Techniques used for alluring model photos include.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-7 items-center">
            <div className="shadow-lg rounded-lg overflow-hidden w-full max-w-[400px] hover:scale-105 transition duration-300">
              ...
              <p className="text-lg mt-3 p-3">
                ...
                create a polished, natural look, ensuring the model appears
                their best without heavy modifications.
              </p>
            </div>
          </div>
        </div>
        ...
        <div id="page2" className="">
          <h1
            ref={textRef}
            className="text-[7vh] md:text-[30vh] text-center font-bold mx-auto md:m-0 text-[#ADB5BD]"
          >
            EXPERIENCE
          </h1>
        </div>
        ...
        <div className="min-h-screen flex flex-col justify-center w-auto text-left p-6 sm:px-10 md:px-20">
          <motion.h1
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, ease: "easeOut" }}
            viewport={{ once: false, amount: 0.5 }}
            className="text-[10vh] w-full  md:text-[38vh] font-bold py-10  sm:py-10 sm:px-0 text-[#ADB5BD]"
          >
            Let&rsquo;s Talk
          </motion.h1>
          <a href="/cv.pdf" download className="">
            <button className="px-6 py-2 border rounded transition-all hover:bg-green-400">
              Download CV
            </button>
          </a>
        </div>
        <div className="min-h-screen ">
          <motion.h1
            ...
            transition={{ duration: 0.8, ease: "easeOut" }}
            viewport={{ once: false, amount: 0.5 }}
            className=" w-full  text-7xl text-center font-bold py-10  sm:py-10 sm:px-0 text-[#ADB5BD]"
          >
            Contact Me
          </motion.h1>
          <Contact />
