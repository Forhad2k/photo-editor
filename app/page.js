...
Let me know if you&rsquo;d like any refinements!
      ...
      >
        ...
        <div className="grid w-full sm:pb-10 sm:pt-10 md:w-[80%] md:pb-28 md:pt-16 h-auto items-center m-auto gap-7 md:grid-cols-3">
          {/* Left Column */}
          <div className="flex flex-col gap-7 items-center">
            <div className="shadow-lg rounded-lg overflow-hidden w-full max-w-[400px] hover:scale-105 transition duration-300">
          <BeforeAfterCard
        ...
        <div id="page2" className="h-screen w-full">
          <h1 ref={textRef} className="text-[70vh] font-bold  text-[#ADB5BD]">
            EXPERIENCE
          </h1>
        </div>
        {/* Grid Section End */}
      ...
      <div className="min-h-screen w-auto flex flex-col items-start justify-center text-left px-6 sm:px-10 md:px-20">
  <motion.h1
    initial={{ opacity: 0, x: 50 }}
    whileInView={{ opacity: 1, x: 0 }}
    transition={{ duration: 0.8, ease: "easeOut" }}
    viewport={{ once: false, amount: 0.5 }}
    className="text-[10vh] w-full sm:text-6xl md:text-[38vh] font-bold p-6 sm:p-10 text-[#ADB5BD]"
  >
    Let&rsquo;s Talk
  </motion.h1>
  <a href="/cv.pdf" download className="mx-5 self-start">
    <button className="px-6 py-2 md:ml-14 border rounded transition-all hover:bg-green-400">
      Download CV
    </button>
  </a>
</div>

<footer id="footer" className="bg-gray-800 text-white py-6 flex justify-center items-center">
